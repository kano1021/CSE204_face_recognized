...
class Age_Model:
    ...
    def train(self, batch_size=128, epochs=1, file_name=None):
        """
...
if __name__ == '__main__':
    if len(sys.argv) != 1:
        ...
        ds.load(0)
        gm = Age_Model(ds)
        #gm.load_model(file_name = '/Users/YuYinfeng/Desktop/Semester 4/CSE_204_ML/Project/age_classifier.h5')
        gm.train(file_name="/Users/YuYinfeng/Desktop/Semester 4/CSE_204_ML/Project/age_classifier.h5")
        #model = load_model("age_classifier.h5")
